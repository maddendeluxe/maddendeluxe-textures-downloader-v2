...
#[allow(dead_code)]
pub const APP_TITLE: &str = "Madden 04 Deluxe Downloader";

/// Repository owner (GitHub username or organization)
pub const REPO_OWNER: &str = "maddendeluxe";

/// Name of the texture mod repository
pub const REPO_NAME: &str = "madden04deluxe";

/// Full URL to the git repository
pub const REPO_URL: &str = "https://github.com/maddendeluxe/madden04deluxe.git";

/// The target folder name (typically the PS2 game identifier like SLUS-XXXXX)
pub const SLUS_FOLDER: &str = "SLUS-20752";

/// Path within the repo to sparse checkout
pub const SPARSE_PATH: &str = "textures/SLUS-20752";

/// Temporary directory name used during clone
pub const TEMP_DIR_NAME: &str = "_temp_madden04deluxe_repo";
